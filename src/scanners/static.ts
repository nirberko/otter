...
const CAP_RULES: CapRule[] = [
	{
		id: "MCP-CAP-001",
		re: /child_process|require\(['"]child_process['"]\)/,
		title: "Spawns child processes",
		severity: "medium",
	},
	{
		id: "MCP-CAP-002",
		re: /\bexec(?:Sync)?\s*\(|\bspawn(?:Sync)?\s*\(/,
	...
	{
		id: "MCP-CAP-004",
		re: /\bvm\.runIn|require\(['"]vm['"]\)/,
		title: "Uses vm module",
		severity: "medium",
	},
	{
		id: "MCP-CAP-005",
		re: /\b(subprocess|os\.system|os\.popen|Popen)\b/,
		title: "Executes shell commands (python)",
		severity: "medium",
	},
];
