...
import { isScannable, rankRows, rowFromReport, type CatalogRow } from './catalog.js'
...
async function main(): Promise<void> {
  ...
  process.stderr.write(`Summarized ${ranked.length} servers → ${SUMMARY} (${missing} not yet scanned)\n`)
}
